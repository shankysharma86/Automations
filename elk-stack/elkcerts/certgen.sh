...
VERSION="7.8.0" HOSTCERTSDIR="/Users/shashanksharma/Documents/docker/elk-stack/elkcerts" ESCERTSDIR="/usr/share/elasticsearch/config" KIBCERTSDIR="/usr/share/kibana/config" docker-compose up -d
